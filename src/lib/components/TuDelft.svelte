...
<div id="TuDelftContainer" class="flex min-h-screen p-16 py-8 pr-8 text-left space-y-4 z-10">
    <Frame borderColour="bg-blue" bgColour="bg-white">
        <h1 class="text-2xl">College</h1>
        <p class="font-bold">
