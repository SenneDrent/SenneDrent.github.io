...
<div id="HiHorizonContainer" class="flex min-h-screen p-16 text-left space-y-4 z-10">
    <div class='flex flex-grow bg-red p-5 z-10'>
        <div class="flex flex-grow bg-white p-2">
            <div class="flex-grow bg-lightRed text-greenBlack p-5">
                ...
                <h2 class="text-xl">On board telemetry</h2>
                <p class="font-bold">
                ...
                <h2 class="text-xl">Telemetry Website</h2>
                <p class="font-bold">
